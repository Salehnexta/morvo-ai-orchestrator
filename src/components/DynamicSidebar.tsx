...
export const DynamicSidebar: React.FC<DynamicSidebarProps> = ({ 
  ...
  const renderDefaultContent = () => (
    <div className="h-full bg-gradient-to-br from-slate-800 via-blue-900 to-indigo-900 relative overflow-hidden">
      ...
      <div className="relative z-10 p-6 h-full flex flex-col justify-center items-center text-center">
        <div className="bg-black/30 backdrop-blur-sm p-8 rounded-2xl border border-white/20">
  ...
  return (
    <div className="w-80 h-full border-r border-gray-200 dark:border-gray-700" dir={isRTL ? 'rtl' : 'ltr'}>
      {renderContent()}
    </div>
  );
};
