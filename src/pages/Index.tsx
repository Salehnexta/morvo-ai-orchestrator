...
const content = {
  ar: {
    hero: {
      title: "حان الوقت لتغيير عالم التسويق",
...
يقوم تلقائيًا بـ صياغة الاستراتيجية، إنشاء المحتوى العربي والإنجليزي، تحسين نتائج البحث، إدارة الحملات الإعلانية، متابعة المنافسين، تحليل الأداء، والتفاعل مع جمهورك — كل ذلك دون تدخل يدوي`,
    ...
    finalCta: {
      title: "المستقبل ليس وجهة ننتظرها، بل واقعٌ نصنعه اليوم",
      description: "مع مورفو AI، أنت لا تحصل على أداة، بل شريك استراتيجي ينمو مع طموحاتك. حوّل بياناتك إلى فرص، وتحدياتك إلى انتصارات. ابدأ اليوم وشكّل مستقبل أعمالك بقرارات أذكى ونتائج تتجاوز توقعاتك.",
