...
const FirstTimeSetup: React.FC = () => {
  ...
  const calculateCompleteness = () => {
    const requiredFields = [
      'full_name', 'company_name', 'industry', 'company_size', 
      'company_overview', 'marketing_experience', 'monthly_marketing_budget'
    ];
  ...
  const handleArrayFieldChange = (field: 'primary_marketing_goals' | 'unique_selling_points', value: string, checked: boolean) => {
    setProfile(prev => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-white mb-2">مرحباً بك في مورفو! 🚀</h1>
          <p className="text-blue-200 text-lg">دعنا نتعرف على عملك لنقدم لك أفضل استراتيجيات التسويق الرقمي</p>
          ...
          <CardContent className="p-8">
            <Tabs value={currentTab} onValueChange={setCurrentTab} className="w-full">
              <TabsList className="grid w-full grid-cols-4 bg-slate-700/50 mb-8">
                <TabsTrigger value="basic" className="data-[state=active]:bg-blue-600 text-white">
                  <User className="w-4 h-4 mr-2" />
                  المعلومات الأساسية
                </TabsTrigger>
                <TabsTrigger value="business" className="data-[state=active]:bg-blue-600 text-white">
                  <Building className="w-4 h-4 mr-2" />
                  تفاصيل العمل
                </TabsTrigger>
                <TabsTrigger value="marketing" className="data-[state=active]:bg-blue-600 text-white">
                  <Target className="w-4 h-4 mr-2" />
                  التسويق والأهداف
                </TabsTrigger>
                <TabsTrigger value="contact" className="data-[state=active]:bg-blue-600 text-white">
              ...
              <TabsContent value="basic" className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    <Label htmlFor="greeting_preference" className="text-white">طريقة المخاطبة المفضلة</Label>
                  ...
                  <div>
                    <Label htmlFor="company_name" className="text-white">اسم الشركة *</Label>
                    <Input
                      id="company_name"
                  ...
                  <div>
                    <Label htmlFor="company_size" className="text-white">حجم الشركة *</Label>
                    <Select value={profile.company_size} onValueChange={(value) => updateProfile('company_size', value)}>
                      <SelectTrigger className="bg-slate-700/50 border-slate-600 text-white">
                  ...
                  <div>
                    <Label htmlFor="website_url" className="text-white">رابط الموقع الإلكتروني</Label>
                    <Input
                      id="website_url"
                      type="url"
                ...
                <div>
                  <Label htmlFor="company_overview" className="text-white">نبذة عن الشركة *</Label>
                  <Textarea
                    id="company_overview"
              ...
              <TabsContent value="business" className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <Label htmlFor="business_type" className="text-white">نوع النشاط</Label>
                  ...
                  <div>
                    <Label htmlFor="target_market" className="text-white">السوق المستهدف</Label>
                    <Input
                      id="target_market"
                  ...
                  <div>
                    <Label htmlFor="current_monthly_revenue" className="text-white">الإيرادات الشهرية الحالية</Label>
                  ...
                  <div>
                    <Label htmlFor="revenue_target" className="text-white">هدف الإيرادات</Label>
                    <Input
                      id="revenue_target"
                  ...
                  <div className="grid grid-cols-2 gap-2 mt-2">
                    {[
                      ...
                      <div key={point} className="flex items-center space-x-2 space-x-reverse">
                        ...
                        />
                        <Label htmlFor={point} className="text-sm text-white">{point}</Label>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              <TabsContent value="marketing" className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <Label htmlFor="marketing_experience" className="text-white">خبرتك في التسويق *</Label>
                  ...
                  <div>
                    <Label htmlFor="monthly_marketing_budget" className="text-white">الميزانية التسويقية الشهرية *</Label>
                ...
                <div>
                  <Label className="text-white">ما هي أهدافك التسويقية الأساسية؟</Label>
                    ...
                    {[
                      ...
                      <div key={goal} className="flex items-center space-x-2 space-x-reverse">
                        <Checkbox
                          ...
                          className="border-slate-400"
                        />
                        <Label htmlFor={goal} className="text-sm text-white">{goal}</Label>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div>
                  <Label htmlFor="biggest_marketing_challenge" className="text-white">أكبر تحدي تسويقي تواجهه</Label>
                  <Textarea
              ...
              <TabsContent value="contact" className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <Label htmlFor="contact_email" className="text-white">البريد الإلكتروني</Label>
                    <Input
                      id="contact_email"
                      type="email"
                  ...
                  <div>
                    <Label htmlFor="contact_phone" className="text-white">رقم الهاتف</Label>
                    <Input
                      id="contact_phone"
                ...
                <div>
                  ...
                  <div className="space-y-3">
                    {((profile.key_team_members as any[]) || []).map((member, index) => (
